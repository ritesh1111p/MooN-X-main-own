...
module.exports = {
    ...
    MODE: process.env.BOT_MODE || 'self', // 'self' or 'public'
    BOT_NAME: process.env.BOT_NAME || '💀MooN-X bot💀',
    VERSION: process.env.BOT_VERSION || '1.0.0',
    BOT_FOOTER: process.env.BOT_FOOTER || 'CREATE BY MooN-X',
    ...
    // Group Settings
    GROUP_INVITE_LINK: process.env.GROUP_INVITE_LINK || 'https://whatsapp.com/channel/0029Vb7HL5C0rGiUaquNz21g',
    ...
    // Media URLs
    RCD_IMAGE_PATH: process.env.RCD_IMAGE_PATH || 'https://files.catbox.moe/b9qlrn.jpg', // add your bot url
    MENU_IMAGE_URL: process.env.MENU_IMAGE_URL || 'https://files.catbox.moe/b9qlrn.jpg', //add ur bot url
    ...
    // Owner Settings
    OWNER_NUMBER: process.env.OWNER_NUMBER || '919668738914', // ᴀᴅᴅ ʏᴏᴜʀ ᴏᴡɴᴇʀ ɴᴜᴍʙᴇʀ
    OWNER_NAME: process.env.OWNER_NAME || 'MooN-X', // ᴀᴅᴅ ʏᴏᴜʀ ᴏᴡɴᴇʀ ɴame
    
    // Channel Links
    CHANNEL_LINK: process.env.CHANNEL_LINK || 'https://whatsapp.com/channel/0029Vb7HL5C0rGiUaquNz21g',
    
    // GitHub Settings
    GITHUB_OWNER: process.env.GITHUB_OWNER || 'ritesh1111p', //add your github username
